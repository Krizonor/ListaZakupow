...
function buildCSS(dark) {
  const t = dark ? {
    bg: "#111816",
    surface: "#1A2320",
    surfaceBorder: "#2A3530",
    text: "#E8F0EC",
    textMuted: "#6B8A7A",
    sidebar: "#0D1512",
    sidebarBorder: "rgba(255,255,255,0.05)",
    sidebarText: "rgba(255,255,255,0.5)",
    sidebarTextHover: "rgba(255,255,255,0.82)",
    sidebarActive: "rgba(255,255,255,0.09)",
    inputBg: "#161E1C",
    inputBorder: "#2E3D38",
    inputFocus: "#3A7558",
    cardBorder: "#252F2C",
    progressTrack: "#252F2C",
    filterTab: "#1A2320",
    filterTabBorder: "#2A3530",
    filterTabText: "#5A8070",
    badgeGreenBg: "#1A3028", badgeGreenColor: "#5CAF88",
    badgeAmberBg: "#2A2010", badgeAmberColor: "#C49020",
    badgeGrayBg: "#222222", badgeGrayColor: "#888888",
    badgeRedBg: "#2A1010", badgeRedColor: "#C44040",
    btnIcon: "#3D5248",
    productRowHover: "#161E1C",
    checkboxBorder: "#3A5048",
    sectionLabel: "#4CAF80",
    catChipBg: "#162820", catChipColor: "#4CAF80",
    modalBg: "#171F1D",
    formLabel: "#4CAF80",
    divider: "#222F2A",
  } : {
    ...
    sidebarTextHover: "rgba(255,255,255,0.88)",
    sidebarActive: "rgba(255,255,255,0.11)",
    inputBg: "#FAFAF8",
    inputBorder: "#D0CCC5",
    inputFocus: "#3A7558",
    cardBorder: "#E8E3DC",
    progressTrack: "#EAE7E2",
    filterTab: "white",
    filterTabBorder: "#D0CCC5",
    filterTabText: "#7A8C79",
    badgeGreenBg: "#D6EEE2", badgeGreenColor: "#276040",
    badgeAmberBg: "#FEF1D5", badgeAmberColor: "#7A540B",
    badgeGrayBg: "#EAE7E2", badgeGrayColor: "#5E5A55",
    badgeRedBg: "#FDECEA", badgeRedColor: "#9B2424",
    btnIcon: "#B0A8A0",
    productRowHover: "#FAFAF8",
    checkboxBorder: "#BEB9B2",
    sectionLabel: "#3A7558",
    catChipBg: "#EEF5F1", catChipColor: "#2E6044",
    modalBg: "white",
    formLabel: "#4E6248",
    divider: "#F2EEE9",
  };
  ...
  return `
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .sidebar-btn:hover { background: rgba(255,255,255,0.06); color: ${t.sidebarTextHover}; }
    .sidebar-btn.active { background: ${t.sidebarActive}; color: white; }

    .sidebar-btn .list-dot {
    ...
    .list-card {
      ...
      padding: 22px 24px;
      cursor: pointer;
      transition: transform 0.13s, box-shadow 0.13s, border-color 0.13s, background 0.25s;
    }

    .list-card:hover {
      transform: translateY(-2px);
      box-shadow: 0 8px 28px rgba(0,0,0,${dark ? "0.3" : "0.07"});
      border-color: ${dark ? "#3A5248" : "#C9C2B8"};
    }
    ...
    .btn-primary:hover { background: #2E5F45; }
    .btn-primary:active { transform: scale(0.97); }

    .btn-ghost {
      background: none;
      border: 1px solid ${dark ? "#2E3D38" : "#CABFB4"};
      padding: 9px 16px;
      border-radius: 10px;
      font-family: 'DM Sans', sans-serif;
      font-size: 13.5px;
      cursor: pointer;
      color: ${dark ? "#5CAF88" : "#4E6248"};
    ...
    .btn-ghost:hover { background: ${dark ? "#1A2820" : "#F0EDE8"}; border-color: ${dark ? "#3A5048" : "#B0A89E"}; }
    ...
    .btn-icon:hover { background: ${dark ? "#2A1010" : "#FFEEEE"}; color: #CC4444; }
    ...
    .input:focus { border-color: ${t.inputFocus}; background: ${dark ? "#1A2A24" : "white"}; box-shadow: 0 0 0 3px rgba(58,117,88,0.15); }
    ...
    .select:focus { border-color: ${t.inputFocus}; box-shadow: 0 0 0 3px rgba(58,117,88,0.15); }
    ...
    .badge-green { background: ${t.badgeGreenBg}; color: ${t.badgeGreenColor}; }
    .badge-amber { background: ${t.badgeAmberBg}; color: ${t.badgeAmberColor}; }
    .badge-gray { background: ${t.badgeGrayBg}; color: ${t.badgeGrayColor}; }
    .badge-red { background: ${t.badgeRedBg}; color: ${t.badgeRedColor}; }
    ...
    .progress-fill {
      height: 100%;
      background: linear-gradient(90deg, #3A7558, #5CA87A);
      border-radius: 3px;
    ...
    .product-row:hover { background: ${t.productRowHover}; border-radius: 8px; margin: 0 -8px; padding: 13px 8px; }
    ...
    .product-name { font-size: 14px; font-weight: 500; color: ${t.text}; }
    .product-name.done { text-decoration: line-through; color: ${dark ? "#3A5248" : "#B0A8A0"}; }
    .product-meta { font-size: 12px; color: ${t.textMuted}; margin-top: 1px; }
    ...
    .filter-tab {
      padding: 7px 14px;
      border-radius: 8px;
      border: 1px solid ${t.filterTabBorder};
      font-size: 13px;
      cursor: pointer;
      font-family: 'DM Sans', sans-serif;
      transition: all 0.12s;
      background: ${t.filterTab};
      color: ${t.filterTabText};
    }

    .filter-tab.active {
      background: ${dark ? "#2A4A3C" : "#243830"};
      border-color: ${dark ? "#2A4A3C" : "#243830"};
      color: white;
    }
    ...
    .modal-overlay {
      position: fixed;
      inset: 0;
      background: rgba(${dark ? "0,0,0,0.7" : "28,43,26,0.52"});
      display: flex;
      align-items: center;
    ...
    .modal {
      ...
      max-height: 88vh;
      overflow-y: auto;
      box-shadow: 0 24px 72px rgba(0,0,0,${dark ? "0.5" : "0.18"});
      border: 1px solid ${t.cardBorder};
    }
    ...
    .cat-chip {
      ...
      padding: 3px 9px;
      border-radius: 6px;
      background: ${t.catChipBg};
      color: ${t.catChipColor};
    }
